...
public class SubMenuScaling : MonoBehaviour
{
    ...
    /// <summary>
    /// Resets the frame to the initial state (as in prefab).
    /// Sets references to properties.
    /// </summary>
    private void Reset()
    {
        width = 1;
        ...
        topCorners.localPosition = Vector3.zero;
        topLeftCorner.localPosition = Vector3.zero;
        topRightCorner.localPosition = Vector3.zero;
        bottomCorners.localPosition = Vector3.zero;
        bottomLeftCorner.localPosition = Vector3.zero;
        bottomRightCorner.localPosition = Vector3.zero;

        verticalSides.localScale = Vector3.one;
        horizontalSides.localScale = Vector3.one;
